...
% for a stick-slip regime [k = 168 N/m; V = 42 microns/s].
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
msg3='for a STICK-SLIP REGIME [k = 168 N/m; V = 42 microns/s].';
...
hh=legend([h11,h12,h13,h14],{'data','$\lambda=0.8$','$t_{start}$','$t_{stop}$'},'Location','NorthWest');
...
xlabel('$t$ [s]','interpreter','Latex','Fontname','Times','FontSize', 16)
ylabel('$F/mg$ [-]','interpreter','Latex','Fontname','Times','FontSize', 16)
hh=legend([h21,h22,h23,h24],{'data','$\lambda=5 \times 10^4$','$t_{start}$','$t_{stop}$'},'Location','NorthWest');
set(hh,'interpreter','latex','Fontname','Times','Fontsize',11)  % pour l'interpréter en Latex
%
linkaxes([ax1,ax2],'xy')
